...
const CompanyProductsTable: FC<CompanyProductsTableProps> = ({ products }) => {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return products.filter(
      (product) =>
        ...
        (product.price != null && String(product.price).includes(lowerFilter))
    );
  }, [products, filter]);
  ...
  return (
    <div className="w-full">
      ...
      <div className="mb-6">
        <input
          type="text"
          placeholder="Search products by name, description, or categories..."
          value={filter}
          onChange={(e) => {
