    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          <h2 id="delete-article-modal-title" className="text-lg font-semibold text-gray-900">
            Delete article
          </h2>
          <button
            type="button"
        ...
        <div className="p-4">
          <p className="text-gray-600">Are you sure you want to delete this article? This cannot be undone.</p>
        </div>
